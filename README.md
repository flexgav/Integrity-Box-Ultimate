...
* 🧰 **GMS Tools:** мягкий перезапуск Google Play Services/Play Store, сброс данных Google Wallet и глубокая очистка GMS/Play Store/GSF для повторной подготовки устройства к проверке Play Маркета.
* 🧼 **App Data Cleaner:** очистка данных и кэша отдельно выбранных приложений — удобно после смены HMA, Target-профиля, props или Boot Hash, чтобы приложение заново проверило окружение.
